...
namespace Task_3._1.Nunit
{
	...
	public class SubTestCases : BaseNunitTestClass
    {
		...
		[TestCase("-10", "15")]
		[TestCase("-10", "-15")]
		public void CheckSubTwoStringInt(string number1, string number2)
        {
		...
		[TestCase("-10.1", "15.1")]
		[TestCase("-10.1", "-15.1")]
		public void CheckSubTwoStringDouble(string number1, string number2)
        {
		...
		[TestCase("-10", "15.1")]
		[TestCase("-10", "-15.1")]
		public void CheckSubStringIntStringDouble(string number1, string number2)
        {
        ...
        [Test]
        public void CheckSubStringValue()
        {
